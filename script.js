$(document).ready(function(){
    ...
    function email_validation(){
        var email1=new RegExp(/^([_\-\.0-9a-zA-Z]+)@([_\-\.0-9a-zA-Z]+)\.([a-zA-Z]){2,7}$/);
        ...
        if(!email1.test(email_val))
        {
            ...
            $('#emailvalidation').show();
            $('#emailvalidation').html('Please enter the email in correct format');
            $('#emailvalidation').css('color','red');
            email_error=false;
            return false;
        }
    ...
    function password_validation(){
        var password1=new RegExp(/^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[^a-zA-Z0-9])(?!.*\s).{8,15}$/);
        ...
        if(!password1.test(password_val))
        {
            ...
            $('#passwordvalidation').show();
            $('#passwordvalidation').html('Password should contain atleast one small character, one captical character, one digit, one special character');
            $('#passwordvalidation').css('color','red');
            password_error=false;
            return false;
        }
